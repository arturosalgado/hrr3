...
public class ListboxArrowKeyModelView {
	...
	@Wire
	public Listbox genericListBox;
	
	private int headerCountElements = 0;
	private List<XulElement> lstComponents;
	
	public ListboxArrowKeyModelView(int headerCount) {
	...
	@Command
	public void doArrowManagement(@BindingParam("e")KeyEvent event){
