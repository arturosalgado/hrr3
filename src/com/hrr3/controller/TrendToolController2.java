...
public class TrendToolController2 extends ListboxArrowKeyController  {
	    ...
	    public void loadTrendDataOnClick() throws WrongValueException, ParseException {		
			...
			mainApp.addEventListener(Events.ON_CLIENT_INFO, new EventListener<Event>() {
		        ...
		        public void onEvent(Event event) throws Exception {
		        	...
		        	refreshListData(TrendToolController2.LOAD_TREND_DATA);
		 ...
		 mainApp = this.trendDialog;		 	
			...
			mainApp.addEventListener(Events.ON_CLIENT_INFO, new EventListener<Event>() {
		        ...
		        public void onEvent(Event event) throws Exception {
		        	...
		        	refreshListData(TrendToolController2.CALCULATE_TREND_DATA);
