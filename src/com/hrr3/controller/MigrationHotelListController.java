...
public class MigrationHotelListController extends SelectorComposer<Component> {
	...
	public void showModal() {
		...
		System.out.println("*********** Selected hotel: " + selectedHotel.getName() + " hotelId: " + selectedHotel.getHotelId() +  " **************");
        ...
        if(customer != null && customer.getCustomerId() != null) {
            ...
            map.put("customerId", customerId);
     		Window window = (Window)Executions.createComponents("/application/admin/migration/components/snapshots-popup.zul", null, map);		
     		window.doModal();
