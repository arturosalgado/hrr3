 ...
 */
@WebServlet("/controllertrendtool")
public class ControllerTrendTool extends HttpServlet {
	...
	RequestDispatcher view = request.getRequestDispatcher("WEB-INF/views/trendtool.jsp");
