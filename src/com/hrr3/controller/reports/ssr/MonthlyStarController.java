...
public class MonthlyStarController extends SelectorComposer<Component>  {
	...
	public void doAfterCompose(Component comp) throws Exception {
        ...
        popupDialog.setTitle("Monthly Star Report");
	}
    ...
    public void printReportBtn() {
    	...
    	new JasperServerReportBuilder().buildExecutionURL(JasperServerReportsConfig.SSR_MONTHLY_STAR, JasperServerReportsConfig.PDF_FORMAT, inputReportParameters, true); 	
